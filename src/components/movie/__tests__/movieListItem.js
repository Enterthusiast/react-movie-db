...
describe('render', () => {
  it('shallow renders without crashing', () => {
    shallow(<MovieListItem {...props} />);
  });

  it('renders without crashing', () => {
    const div = document.createElement('div');
    ReactDOM.render(<MovieListItem {...props} />, div);
...
describe('vote', () => {
  it('show a # percentage if vote_average and vote_count are falsy', () => {
    props.movieListItem = { vote_average: 0, vote_count: 0, id: 1 };
  ...
  it('show a percentage if vote_average and vote_count are truthy', () => {
    props.movieListItem = { vote_average: 6.6, vote_count: 6, id: 1 };
...
describe('release_date', () => {
  it('show release date if truthy', () => {
    props.movieListItem = { release_date: '1984-10-31', id: 1 };
