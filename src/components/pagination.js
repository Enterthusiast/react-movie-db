...
const Pagination = (props) =>
    <div>
        <ul className="App-pagination pagination center-align">
            ...
            {props.list ? props.list.map(page => <li key={page} className={`App-pagination-page ${props.current === page ? "active" : "waves-effect"}`}><a onClick={(e) => props.change(page)}>{page}</a></li>) : null}
